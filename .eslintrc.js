    ...
    rules: {
        ...
        camelcase: [
            'error',
            {
                ...
                allow: ['_ts$', '_ns$', '_ms$', '_s$', '_m$', '_h$', '_deg$', '_rad$', '_Hz$', '_kHz$', '_V$'],
            },
        ],
        ...
        indent: ['error', 4, {
            ...
            outerIIFEBody: 1, // MemberExpression: null,
            FunctionDeclaration: {
                parameters: 1, body: 1,
            },
            FunctionExpression: {
            ...
            ObjectExpression: 1,
            ImportDeclaration: 1,
            flatTernaryExpressions: false, // list derived from https://github.com/benjamn/ast-types/blob/HEAD/def/jsx.js
        ...
        // disallow multiple empty lines, only one newline at the end, and
        // no new lines at the beginning
        ...
        //     allow: [], allowAfterThis: true, allowAfterSuper: false, enforceInMethodNames: true,
        // }],
        ...
        'spaced-comment': ['error', 'always', {
            line: {
                exceptions: ['-', '+'], markers: ['=', '!', '/'], // space here to support sprockets directives, slash for TS /// comments
            },
            block: {
                exceptions: ['-', '+'],
